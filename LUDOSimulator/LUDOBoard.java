...
import LUDOSimulator.GameEventListener.EventType;
/**
...
public class LUDOBoard extends Canvas
{
	...
	private ArrayList<GameEventListener> gameEventListeners = new ArrayList<GameEventListener>();
...
//		greenPlayer = new SemiSmartLUDOPlayer(this);
	...
	public LUDOPlayer getPlayer(int color)
	{
		switch(color) {
...
//				Hit opponent home from "my" globe
				...
				for(GameEventListener eventListener : gameEventListeners)
					eventListener.gameEvent(this,EventType.pieceMoved,nr);
